...
describe('Testing all functionalities', function () {
    describe('Testing the endpoint response', function () {
        it('Response has been get', function (done) { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/api/images?name=fjord&width=500&height=500')];
                    case 1:
                        response = _a.sent();
